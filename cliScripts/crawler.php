 ...
 */
mysqli_query($dbl, "INSERT INTO `log` (`logLevel`, `text`) VALUES (1, '[CRON, Crawl] Crawlvorgang beendet (total: ".$totalPosts.", new: ".$newPosts.", updated: ".$updatedPosts.")')") OR DIE(MYSQLI_ERROR($dbl));
