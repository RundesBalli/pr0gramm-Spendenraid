 ...
 * krebshilfefast.php
 * 
 * Schnellbewertungsseite zum Setzen der Spendenorganisation "Deutsche Krebshilfe"
 */
 ...
 */
$title = "Deutsche Krebshilfe Schnellbewertung";
$content.= "<h1>Deutsche Krebshilfe Schnellbewertung</h1>".PHP_EOL;
$content.= "<h3 class='warn'>GENAU LESEN:</h3>".PHP_EOL;
$content.= "<div class='row'>".PHP_EOL.
"<div class='col-x-12 col-s-12 col-m-12 col-l-12 col-xl-12 warn bold'>Beim Klick auf einen Thumbnail wird er DIREKT der Deutschen Krebshilfe zugeordnet (Erst- und Zweitsichtung wie über die normale Bewertung finden trotzdem statt!).</div>".PHP_EOL.
...
if(mysqli_num_rows($result) != 0) {
  ...
  while($row = mysqli_fetch_array($result)) {
    $content.= "<a href='/orgafast?postId=".$row['postId']."&orgaId=2'><img src='https://thumb.pr0gramm.com/".$row['thumb']."' alt='Thumb'></a>".PHP_EOL;
  }
  $content.= "</div>".PHP_EOL;
} else {
  /**
