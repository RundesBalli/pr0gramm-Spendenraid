...
$content.= "<h1>DKMS Schnellbewertung</h1>";
$content.= "<h3 class='warn'>GENAU LESEN:</h3>";
$content.= "<div class='row'>".
"<div class='col-x-12 col-s-12 col-m-12 col-l-12 col-xl-12 warn bold'>Beim Klick auf einen Thumbnail wird er DIREKT der DKMS zugeordnet (Erst- und Zweitsichtung wie über die normale Bewertung finden trotzdem statt!).</div>".
...
if(mysqli_num_rows($result) != 0) {
  ...
  while($row = mysqli_fetch_array($result)) {
    $content.= "<a href='/orgafast?postId=".$row['postId']."&orgaId=1'><img src='https://thumb.pr0gramm.com/".$row['thumb']."' alt='Thumb'></a>";
  }
  $content.= "</div>";
} else {
  /**
